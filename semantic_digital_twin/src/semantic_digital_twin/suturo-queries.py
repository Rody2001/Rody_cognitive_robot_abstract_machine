...
from krrood.entity_query_language.factories import variable_from, flat_variable, entity
from krrood.entity_query_language.query.query import Entity
from krrood.utils import inheritance_path_length
from semantic_digital_twin.reasoning.predicates import is_supported_by, compute_euclidean_distance_2d, is_supporting
