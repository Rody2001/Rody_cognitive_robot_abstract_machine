...
from semantic_digital_twin.semantic_annotations.semantic_annotations import Milk, Table, Orange, Carrot, Lettuce, \
    Banana, Apple
...
from semantic_digital_twin.world_description.geometry import Box, Scale, Cylinder, Color
